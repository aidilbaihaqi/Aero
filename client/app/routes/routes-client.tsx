...
export function RoutesClient({ initialFares }: RoutesClientProps) {
    ...
    <>
          ...
          <CardSolidContent className="flex items-center gap-4 p-4">
            ...
            <div>
              ...
              <div className="text-2xl font-display font-bold">
                {isLoading && !rawFares ? "—" : routesData.length}
              </div>
            </div>
          </CardSolidContent>
        </CardSolid>
          ...
          <CardSolidContent className="flex items-center gap-4 p-4">
            ...
            <div>
              ...
              <div className="text-2xl font-display font-bold text-green-400">
                {isLoading && !rawFares ? "—" : activeCount}
              </div>
            </div>
          </CardSolidContent>
        </CardSolid>
          ...
          <CardSolidContent className="flex items-center gap-4 p-4">
            ...
            <div>
              ...
              <div className="text-2xl font-display font-bold text-orange-400">
                {isLoading && !rawFares ? "—" : inactiveCount}
              </div>
            </div>
          </CardSolidContent>
        </CardSolid>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="w-full md:w-[200px]">
          <Select value={selectedAirline} onValueChange={(val) => {
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm border border-neutral-100 overflow-hidden">
        ...
        {/* Pagination */}
        {(!isLoading || rawFares) && filteredRoutes.length > itemsPerPage && (
